...
elseif (ucase==2)
    f = exp(t)*cos(pi*x)*cos(pi*y) + (2*pi^2*exp(t)*cos(pi*x)*cos(pi*y))/(pi^2*exp(2*t)*cos(x*pi)^2*sin(y*pi)^2 + pi^2*exp(2*t)*cos(y*pi)^2*sin(x*pi)^2 + 1)^(1/2) - (pi*exp(t)*cos(pi*y)*sin(pi*x)*(2*pi^3*exp(2*t)*cos(pi*x)*cos(pi*y)^2*sin(pi*x) - 2*pi^3*exp(2*t)*cos(pi*x)*sin(pi*x)*sin(pi*y)^2))/(2*(pi^2*exp(2*t)*cos(x*pi)^2*sin(y*pi)^2 + pi^2*exp(2*t)*cos(y*pi)^2*sin(x*pi)^2 + 1)^(3/2)) - (pi*exp(t)*cos(pi*x)*sin(pi*y)*(2*pi^3*exp(2*t)*cos(pi*x)^2*cos(pi*y)*sin(pi*y) - 2*pi^3*exp(2*t)*cos(pi*y)*sin(pi*x)^2*sin(pi*y)))/(2*(pi^2*exp(2*t)*cos(x*pi)^2*sin(y*pi)^2 + pi^2*exp(2*t)*cos(y*pi)^2*sin(x*pi)^2 + 1)^(3/2));
end
